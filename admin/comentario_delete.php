...
mysql_select_db($database_config, $config);
$query_Consulta = sprintf("SELECT * FROM comentario WHERE comentario.id_comentario = %s", GetSQLValueString($id_Consulta, "int"));
$Consulta = mysql_query($query_Consulta, $config) or die(mysql_error());
