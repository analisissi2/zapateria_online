...
$query_Recordset1 = "Select mensajeria.id_mensajeria, mensajeria.mensajes, mensajeria.usuario_correo, rol.cargo from mensajeria inner join rol on mensajeria.usuario_rol_id_rol = rol.id_rol";
                    ...
                    <div class="col-lg-12"><!-- InstanceBeginEditable name="Contenido" -->
                      ...
                      <thead>
                        ...
                        <tbody>
                                 <?php do { ?>
                                 <tr class="odd gradeX">
                                     <td><?php echo $row_Recordset1['id_mensajeria']; ?></td>
                                     <td><?php echo $row_Recordset1['mensajes']; ?></td>
                                     <td><?php echo $row_Recordset1['usuario_correo']; ?></td>
