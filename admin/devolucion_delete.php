...
mysql_select_db($database_config, $config);
$query_eliminar = sprintf("SELECT * FROM devolucion WHERE devolucion.id_devolucion = %s", GetSQLValueString($id_eliminar, "int"));
