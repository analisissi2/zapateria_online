...
mysql_select_db($database_config, $config);
$query_Eliminar = sprintf("SELECT * FROM tarjeta_credito WHERE tarjeta_credito.id_tdc = %s", GetSQLValueString($id_Eliminar, "int"));
$Eliminar = mysql_query($query_Eliminar, $config) or die(mysql_error());
