...
$query_municipios = "SELECT municipio.id_municipio, municipio.municipio, departamento.departamento FROM municipio inner join departamento on municipio.departamento_id_departamento = departamento.id_departamento";
$municipios = mysql_query($query_municipios, $config) or die(mysql_error());
                    ...
                    <div class="col-lg-12"><!-- InstanceBeginEditable name="Contenido" -->
                      ...
                      <thead>
                        ...
                        <tbody>
                                 <?php do { ?>
                                 <tr class="odd gradeX">
                                     <td><?php echo $row_municipios['id_municipio']; ?></td>
                                     <td><?php echo $row_municipios['municipio']; ?></td>
                                     <td><?php echo $row_municipios['departamento']; ?></td>
                                   </tr>
