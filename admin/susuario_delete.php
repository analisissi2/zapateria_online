...
$id_DeleteAdmin = "0";
if (isset($_GET["id"])) {
  $id_DeleteAdmin = $_GET["id"];
}
mysql_select_db($database_config, $config);
$query_DeleteAdmin = sprintf("CALL `deleteadmin`(%s)", GetSQLValueString($id_DeleteAdmin, "int"));
$DeleteAdmin = mysql_query($query_DeleteAdmin, $config) or die(mysql_error());
