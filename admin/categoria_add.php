...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO categoria (nombre, descripcion) VALUES (%s, %s)",
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
              <div class="row">
                    <div class="col-lg-12">
                      <h1 class="page-header">Añadir Categoria</h1>
                      <p>Agregue la categoria</p>
                    <p>&nbsp;</p>
                       ...
                       <div class="panel panel-default">
                        ...
                        <tr valign="baseline">
                          ...
                          <label for="descripcion"></label>
                            <input type="text" name="descripcion" id="descripcion" maxlength="45">
